 ...
 * @brief FreeRTOS task that reads data from an I²C pressure sensor and updates shared measurements.
 *
 * This task communicates with a digital pressure sensor over I²C, converts the raw 14-bit
...
/**
 * @brief FreeRTOS task that reads pressure data from a sensor and updates the shared measurement.
 *
